<template>
    <div>
        <div class="text-center" style="width: 75%; margin: auto; position: relative;" v-show="scales">
            <img src="/bass-guitar.svg" alt="bass guitar" class="w-full" >
            <div class="neckView">
                ...
                <div  style="width: 100%; height: 2px; margin-top: 2.1%;" class="flex">
                ...
                <div  style="width: 100%; height: 2px; margin-top: 2.6%; transform: skewY(-0.5deg);" class="flex">
                ...
                <div  style="width: 100%; height: 2px; margin-top: 2.1%; transform: skewY(-1deg)" class="flex">
            ...
            <div class="openStrings">
                <div  style="width: 100%; height: 2px; margin-top: 2%; transform: skewY(1deg);" class="flex">
                    <div class="border-r-1 border-black flex items-center justify-center" style="width:100%; height: 2px;">
                        <div class="rounded-full h-2 w-2"  :class="!isNoteInScale(flat? convertSharpToFlat(strings[3]) : strings[3], createNewScale(key.name, key.mode))? '': (key.name === strings[5])? 'bg-green-300' : 'bg-green-100'"></div>
                    </div>
                </div>
                <div  style="width: 100%; height: 2px; margin-top: 1.8%; transform: skewY(.5deg);" class="flex">
                    <div class="border-r-1 border-black flex items-center justify-center" style="width:100%; height: 2px;">
                        <div class="rounded-full h-2 w-2"  :class="!isNoteInScale(flat? convertSharpToFlat(strings[2]) : strings[2], createNewScale(key.name, key.mode))? '': (key.name === strings[4])? 'bg-green-300' : 'bg-green-100'"></div>
                    </div>
                </div>
                <div  style="width: 100%; height: 2px; margin-top: 1.9%; transform: skewY(.4deg);" class="flex">
                    <div class="border-r-1 border-black flex items-center justify-center" style="width:100%; height: 2px;">
                        <div class="rounded-full h-2 w-2"  :class="!isNoteInScale(flat? convertSharpToFlat(strings[1]) : strings[1], createNewScale(key.name, key.mode))? '': (key.name === strings[3])? 'bg-green-300' : 'bg-green-100'"></div>
                    </div>
                </div>
                <div  style="width: 100%; height: 2px; margin-top: 1.7%;" class="flex">
                    <div class="border-r-1 border-black flex items-center justify-center" style="width:100%; height: 2px;">
                        <div class="rounded-full h-2 w-2"  :class="!isNoteInScale(flat? convertSharpToFlat(strings[0]) : strings[0], createNewScale(key.name, key.mode))? '': (key.name === strings[2])? 'bg-green-300' : 'bg-green-100'"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center" style="width: 75%; margin: auto; position: relative;" v-show="!scales">
            <img src="/bass-guitar.svg" alt="bass" class="w-full">
            <div class="neckView">
                <div  style="width: 100%; height: 2px; margin-top: 1.6%; transform: skewY(1deg);" class="flex">
                    <div class="border-r-1 border-black flex items-center justify-center" v-for="note, i in createNewReverseChromaticArray(strings[3])" :style="`width:${fretWidths[i]}%; height: 2px;`">
